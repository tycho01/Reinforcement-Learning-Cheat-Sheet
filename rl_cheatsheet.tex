...
\begin{itemize}
    \item model picking actions without state
    \item e.g. multi-armed bandit
...
\section{\href{https://en.wikipedia.org/wiki/Reinforcement_learning\#Brute_force}{Exhaustive Search}}
usually computationally unviable.
...
\section{\href{https://en.wikipedia.org/wiki/Dynamic_programming}{Dynamic Programming (DP)}}
\begin{itemize}
...
\section{\href{https://en.wikipedia.org/wiki/Monte_Carlo_sampling}{Monte Carlo (MC) Methods}}
\begin{itemize}
...
\section{\href{https://en.wikipedia.org/wiki/Temporal_difference_learning}{Temporal Difference (TD)}}
\begin{itemize}
    \pro DP's bootstrap
    \pro MC's sampling
...
\subsection{\href{https://en.wikipedia.org/wiki/State-action-reward-state-action}{State-action-reward-state-action (SARSA)}}
\begin{itemize}
...
\subsection{Forward View Sarsa(\texorpdfstring{$\lambda$}{lambda}) (/ TD(\texorpdfstring{$\lambda$}{lambda}))}
...
\subsection{Backward View Sarsa(\texorpdfstring{$\lambda$}{lambda}) (/ TD(\texorpdfstring{$\lambda$}{lambda}))}
...
\section{\href{https://en.wikipedia.org/wiki/Q-learning}{Q Learning}}
...
\subsection{\href{https://en.wikipedia.org/wiki/Q-learning\#Deep_Q-learning}{Deep Q Learning (DQL)}}
...
\subsection{\href{https://en.wikipedia.org/wiki/Q-learning\#Double_Q-learning}{Double DQN}}
...
\section{\href{https://en.wikipedia.org/wiki/Reinforcement_learning\#Direct_policy_search}{Policy Gradient}}
learn $\pi$.
\begin{itemize}
